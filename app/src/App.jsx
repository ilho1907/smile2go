...
const GOETTINNEN = [
  ...
  { n: "Abundantia", b: "Fülle", sub: "Göttin der Fülle", hue: ["#E8B64C", "#B85C2E"], sym: "sonne", txt: "Die Fülle des Lebens fließt dir zu. Öffne die Hände — du darfst empfangen, ohne dich klein zu machen." },
  { n: "Fortuna", b: "Fülle", sub: "Göttin des Glücks", hue: ["#D9A441", "#8E5A2E"], sym: "rad", txt: "Das Rad dreht sich zu deinen Gunsten. Vertraue dem Strom des Lebens — er meint es gut mit dir." },
  { n: "Persephone", b: "Loslassen", sub: "Göttin des Wandels", hue: ["#8E4A63", "#4A3358"], sym: "mond", txt: "Jedes Loslassen ist ein stilles Versprechen an dein neues Ich. Lass fallen, was schwer geworden ist." },
  { n: "Kali", b: "Loslassen", sub: "Urkraft der Transformation", hue: ["#6E3A52", "#2E1F33"], sym: "flamme", txt: "Was nicht mehr zu dir gehört, darf heute gehen. In der Auflösung liegt deine Befreiung." },
  { n: "Athene", b: "Klarheit", sub: "Göttin der Weisheit", hue: ["#5C7A99", "#2E4A66"], sym: "auge", txt: "Dein Blick wird klar, wenn der Lärm verstummt. Heute erkennst du, was wirklich wesentlich ist." },
  { n: "Saraswati", b: "Klarheit", sub: "Göttin der Erkenntnis", hue: ["#7A99B8", "#4A6E8E"], sym: "welle", txt: "Weisheit fließt wie Wasser zu dir. Hör auf die leise Stimme deiner Erkenntnis." },
  { n: "Aphrodite", b: "Annahme", sub: "Göttin der Liebe", hue: ["#D96E8B", "#A8455E"], sym: "herz", txt: "Du bist genug — genau so, wie du bist. Nimm dich heute liebevoll und ohne Bedingung an." },
  { n: "Kuan Yin", b: "Annahme", sub: "Göttin des Mitgefühls", hue: ["#C98BA0", "#8E5A78"], sym: "lotus", txt: "Mitgefühl beginnt bei dir selbst. Lege die Strenge ab und sei sanft mit deinem Herzen." },
  { n: "Artemis", b: "Fokus", sub: "Göttin der Zielklarheit", hue: ["#6E8B6A", "#2E4A38"], sym: "pfeil", txt: "Richte deinen Pfeil auf das, was zählt. Deine Kraft liegt in der ruhigen Sammlung." },
  { n: "Hestia", b: "Fokus", sub: "Hüterin der inneren Mitte", hue: ["#8E7A5C", "#5C4A33"], sym: "feuer", txt: "Kehre zu deiner Mitte zurück. Aus deiner inneren Ruhe entsteht deine größte Wirkung." },
  // — Schöpfung —
  { n: "Gaia", b: "Schöpfung", sub: "Urmutter der Erde", hue: ["#7BA05B", "#3E5C2E"], sym: "lotus", txt: "Du bist getragen von der Erde selbst. Wurzle dich ein — und wachse aus deiner eigenen Kraft." },
  { n: "Isis", b: "Schöpfung", sub: "Göttin der Magie & Mutterschaft", hue: ["#3FA9A0", "#1E5F6B"], sym: "sonne", txt: "Deine Magie ist echt. Was zerbrochen scheint, darfst du liebevoll wieder zusammenfügen." },
  { n: "Freya", b: "Schöpfung", sub: "Göttin der Liebe & Fruchtbarkeit", hue: ["#E0A45C", "#B85C6E"], sym: "herz", txt: "Erlaube dir Freude, Sinnlichkeit und Sehnsucht. Dein Herz weiß, wofür es schlägt." },
  { n: "Brigid", b: "Schöpfung", sub: "Göttin des heiligen Feuers", hue: ["#E8863C", "#B8481E"], sym: "flamme", txt: "Entzünde die Flamme in dir. Deine Inspiration will heute in die Welt fließen." },
  { n: "Pachamama", b: "Schöpfung", sub: "Mutter Erde", hue: ["#C57A44", "#5C7A3E"], sym: "sonne", txt: "Nimm dir, was du brauchst — und gib mit vollem Herzen zurück. Alles darf im Fluss sein." },
  { n: "Danu", b: "Schöpfung", sub: "Urmutter der Flüsse", hue: ["#7FB5C9", "#3E6C8E"], sym: "welle", txt: "Fließe wie Wasser um jedes Hindernis. Sanftheit ist deine stärkste Kraft." },
  // — Fülle —
  { n: "Lakshmi", b: "Fülle", sub: "Göttin des Reichtums", hue: ["#E8B64C", "#D96E8B"], sym: "lotus", txt: "Fülle liebt einen offenen, dankbaren Blick. Was du wertschätzt, wächst." },
  { n: "Demeter", b: "Fülle", sub: "Göttin der Ernte", hue: ["#E0B040", "#B8842E"], sym: "sonne", txt: "Was du gesät hast, reift heran. Habe Geduld — deine Ernte kommt zur rechten Zeit." },
  { n: "Ops", b: "Fülle", sub: "Göttin des Überflusses", hue: ["#E0A040", "#B84C3C"], sym: "sonne", txt: "Überfluss beginnt im Innen. Zähle deinen Reichtum, bevor du an Mangel denkst." },
  { n: "Rosmerta", b: "Fülle", sub: "Göttin der Fülle", hue: ["#D9A441", "#5C8E4A"], sym: "rad", txt: "Dein Füllhorn ist längst voll. Öffne dich, um zu empfangen, was schon für dich bereitliegt." },
  { n: "Juno Moneta", b: "Fülle", sub: "Hüterin des Wohlstands", hue: ["#C9963C", "#2E5C8E"], sym: "rad", txt: "Vertraue deinem Wert. Du darfst großzügig zu dir selbst sein." },
  // — Loslassen —
  { n: "Hekate", b: "Loslassen", sub: "Hüterin der Schwellen", hue: ["#8E6EA8", "#3E2E5C"], sym: "mond", txt: "Du stehst an einer Schwelle. Wähle bewusst — und lass zurück, was nicht mitgehen darf." },
  { n: "Morrigan", b: "Loslassen", sub: "Göttin des Wandels", hue: ["#6E5C6E", "#B83C3C"], sym: "auge", txt: "Ein Ende ist auch ein Anfang. Habe Mut, das Alte ziehen zu lassen." },
  { n: "Cerridwen", b: "Loslassen", sub: "Göttin der Wiedergeburt", hue: ["#4A9E9E", "#2E5C5C"], sym: "mond", txt: "Im Kessel der Wandlung entsteht Neues. Vertraue dem, was gerade in dir gärt." },
  { n: "Nephthys", b: "Loslassen", sub: "Göttin des Übergangs", hue: ["#4A5C8E", "#2E2E5C"], sym: "mond", txt: "Auch im Übergang bist du beschützt. Du musst den Weg nicht schon ganz sehen." },
  { n: "Ereshkigal", b: "Loslassen", sub: "Herrin der Tiefe", hue: ["#8E3C3C", "#2E1E1E"], sym: "feuer", txt: "Steig hinab in deine Tiefe. Dort, wo es dunkel ist, wartet deine verborgene Kraft." },
  // — Klarheit —
  { n: "Sophia", b: "Klarheit", sub: "Göttliche Weisheit", hue: ["#E6D08C", "#8E7AA8"], sym: "sonne", txt: "Die Weisheit, die du suchst, wohnt bereits in dir. Werde still und höre hin." },
  { n: "Seshat", b: "Klarheit", sub: "Göttin des Wissens", hue: ["#4A8E6E", "#C9963C"], sym: "auge", txt: "Schreibe deine Geschichte bewusst. Du bist die Autorin deines Weges." },
  { n: "Minerva", b: "Klarheit", sub: "Göttin der Strategie", hue: ["#5C7A9E", "#C9963C"], sym: "auge", txt: "Handle klug statt schnell. Ein klarer Plan trägt dich weiter als bloße Eile." },
  { n: "Metis", b: "Klarheit", sub: "Titanin der Weisheit", hue: ["#3E8E8E", "#8EA0A8"], sym: "welle", txt: "Vertraue deiner leisen inneren Stimme. Sie weiß mehr, als dein Verstand zugibt." },
  { n: "Nisaba", b: "Klarheit", sub: "Göttin der Schrift", hue: ["#D9B441", "#2E4C8E"], sym: "sonne", txt: "Ordne, was chaotisch ist. Klarheit entsteht, wenn du benennst, was wirklich zählt." },
  // — Annahme —
  { n: "Hathor", b: "Annahme", sub: "Göttin der Freude & Liebe", hue: ["#3FA9A0", "#E0A45C"], sym: "sonne", txt: "Lass Freude herein. Du darfst dich schön, geliebt und lebendig fühlen — heute." },
  { n: "Tara", b: "Annahme", sub: "Göttin des Mitgefühls", hue: ["#3E9E6E", "#C9963C"], sym: "lotus", txt: "Hilfe ist näher, als du denkst. Du musst nicht alles allein tragen." },
  { n: "Parvati", b: "Annahme", sub: "Göttin der Hingabe", hue: ["#D96E8B", "#E0A45C"], sym: "herz", txt: "Bleib deinem Herzen treu. Hingabe ist keine Schwäche, sondern Mut." },
  { n: "Oshun", b: "Annahme", sub: "Göttin der Liebe & Süße", hue: ["#E0B040", "#3FA9A0"], sym: "welle", txt: "Sei süß zu dir. Dein Wert hängt nicht von deiner Leistung ab." },
  { n: "Venus", b: "Annahme", sub: "Göttin der Schönheit", hue: ["#E0A0B0", "#C9963C"], sym: "herz", txt: "Du bist liebenswert, genau wie du bist. Empfange Zärtlichkeit — auch von dir selbst." },
  { n: "Radha", b: "Annahme", sub: "Göttin der reinen Liebe", hue: ["#7FA0C9", "#D96E8B"], sym: "lotus", txt: "Reine Liebe fragt nicht nach Bedingungen. Öffne dein Herz, ohne dich zu verlieren." },
  // — Fokus —
  { n: "Diana", b: "Fokus", sub: "Göttin der Jagd", hue: ["#9EA8B5", "#3E5C3E"], sym: "mond", txt: "Ziele klar und ruhig. Dein Blick entscheidet, wohin dein Pfeil fliegt." },
  { n: "Durga", b: "Fokus", sub: "Göttin der Kraft", hue: ["#C93C3C", "#E0A040"], sym: "feuer", txt: "Deine Kraft ist größer als deine Angst. Steh aufrecht für das, was dir heilig ist." },
  { n: "Nike", b: "Fokus", sub: "Göttin des Sieges", hue: ["#E6E0C8", "#C9963C"], sym: "pfeil", txt: "Der Sieg gehört denen, die dranbleiben. Ein Schritt noch — du bist näher, als du denkst." },
  { n: "Vesta", b: "Fokus", sub: "Hüterin des heiligen Feuers", hue: ["#E0A040", "#B8481E"], sym: "flamme", txt: "Hüte deine innere Flamme. Schütze deine Energie vor allem, was sie zerstreut." },
  { n: "Skadi", b: "Fokus", sub: "Göttin der Winterklarheit", hue: ["#9EC9D9", "#5C7A8E"], sym: "mond", txt: "In der Stille des Winters wird alles klar. Zieh dich zurück und finde deine Richtung." },
  { n: "Sekhmet", b: "Fokus", sub: "Göttin der Löwinnenkraft", hue: ["#C93C3C", "#E0A040"], sym: "sonne", txt: "Setze deine Grenzen mit Würde. Dein klares Nein schützt dein wertvolles Ja." },
];
